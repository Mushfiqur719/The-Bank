...
public class Deposit extends JFrame {
	...
	public Deposit() {
		...
		textField_1.setBounds(145, 116, 218, 22);
		...
		JLabel lblDeposit = new JLabel("Depositary Window");
		...
		lblDeposit.setBounds(145, 22, 165, 22);
